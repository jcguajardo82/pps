...
{
    public sealed class CapturePaymentProfile : Profile
    {
        #region Constructors
        public CapturePaymentProfile()
        {
            ...
            CreateMap<string, Ptsv2paymentsidcapturesPaymentInformation>()
                .ConvertUsing<PaymentsIdCapturesPaymentInformationTypeConverter>();
            //PtsPaymentsOrderInformacion
            CreateMap<PaymentOrderProcessRequest, Ptsv2paymentsidcapturesOrderInformation>()
                .ConvertUsing<PaymentsIdCapturesOrderInformationTypeConverter>();
            ...
            CreateMap<string, Ptsv2paymentsidcapturesDeviceInformation>()
                .ConvertUsing<PaymentsIdCapturesDeviceInformationTypeConverter>();
            ...
            //    .ConvertUsing(new PaymentsMerchantDefinedInformationTypeConverter(ServicesEnum.CapturePayment));
            //CapturesPaymentsRequest
            CreateMap<PaymentOrderProcessRequest, CapturesPaymentsRequest>()
                ...
                .ForMember(d => d.TransactionAuthorizationId, s => s.MapFrom(o => o.TransactionAuthorizationId));
        }
        #endregion
    }
}
