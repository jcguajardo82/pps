...
{
    public sealed class ValidateAuthenticationRiskAuthenticationSetupsClientReferenceInformationTypeConverter : ITypeConverter<string, Riskv1authenticationsetupsClientReferenceInformation>
    {
