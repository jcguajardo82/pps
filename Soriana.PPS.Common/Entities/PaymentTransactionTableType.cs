...
{
    [Table(DatabaseSchemaConstants.TABLE_TYPE_NAME_PAYMENT_TRANSACTION)]
    public sealed class PaymentTransactionTableType : EntityBase
    {
        ...
        [SourceNames(ColumnNameConstants.MERCHANTDISE_TYPE)]
