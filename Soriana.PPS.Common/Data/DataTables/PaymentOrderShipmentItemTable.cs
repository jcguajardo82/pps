...
{
    public sealed class PaymentOrderShipmentItemTable : ICreateTable
    {
        #region Public Methods
        public DataTable CreateTable()
        {
            DataTable dataTable = new DataTable(TableValuedParameterConstants.PAYMENT_ORDER_SHIPMENT_ITEM_TABLE_TYPE);
            //Definition Column
