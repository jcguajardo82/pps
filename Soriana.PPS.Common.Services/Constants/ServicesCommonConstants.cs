namespace Soriana.PPS.Common.Services.Constants
{
    public static class ServicesCommonConstants
    {
        #region Constants
        ...
        public const string UPDATE_PAYMENT_TRANSACTION_JSON_REQUEST_SERVICE_NAME = "UpdatePaymentTransactionJsonRequestService";
